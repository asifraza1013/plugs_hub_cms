                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        {{-- <label class="form-control-label" for="">{{ __('Order Number') }}</label> --}}
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center">
                            ...
                            <tr>
                                ...
                                <td class="table-web">
                                    {{ ($order->is_urgent) ? $order->created_at->format('D M Y H:i') : $order->dlvry_time }}
                                </td>
                                {{-- <td class="table-web">
                                    @if (true)
                                ...
                                @endhasrole
                                {{-- <td class="table-web">
                                    @money( $order->total_price, env('CASHIER_CURRENCY','usd'),true)
