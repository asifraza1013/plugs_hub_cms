...
@section('content')
    ...
    <div id="liveorders" class="row">
        ...
        <div class="col-xl-3" style="min-height: 280px">
          ...
          <div class="card">
            ...
            <!-- Card body -->
            <div class="card-body" style="max-height: 350px;overflow-x: auto">
              <!-- List group -->
        ...
        {{-- <div class="col-xl-4" style="min-height: 280px">
            <!-- Members list group card -->
            <div class="card">
              <!-- Card header -->
              <div class="card-header">
        ...
        <div class="col-xl-3" style="min-height: 280px">
            ...
            <div class="card">
              <!-- Card header -->
              <div class="card-header" style="max-height: 350px;overflow-x: auto">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('Driver On The Way')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
                <ul class="list-group list-group-flush list my--3">
                  ...
                  <li v-for="item in onway" class="list-group-item px-0">
                      @include('orders.partials.liveitem')
                  </li>
        ...
        <div class="col-xl-3">
            ...
            <div class="card">
              ...
              <div class="card-header" style="max-height: 350px;overflow-x: auto">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('Picked Up')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
                <ul class="list-group list-group-flush list my--3">
                  ...
                  <li v-for="item in picked" class="list-group-item px-0">
                      @include('orders.partials.liveitem')
                  </li>
