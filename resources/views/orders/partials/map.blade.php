...
<script async defer
            src= "https://maps.googleapis.com/maps/api/js?libraries=geometry,drawing&key=AIzaSyCDQsmKXBQgD4A0pIt5U_5TQjiUHsBu6Ms">
        </script>
<script>
...
function initTheTrackingMap(currentPosiotion,){
    var map = new google.maps.Map(document.getElementById('tracking_map'), {
        zoom: 13,
        center:  new google.maps.LatLng({{ $order->address->lat }}, {{ $order->address->lng }}),
    });
